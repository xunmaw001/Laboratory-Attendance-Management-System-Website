...
<script>
    ...
    function search() {
        ...
        if( yonghuNameSearchInput != null){
            ...
            //所在班级
        var banjiIdStartSearchInput = $('#banjiIdStartSearch');
        if(banjiIdStartSearchInput != null){
            var banjiIdStartSearchValue = banjiIdStartSearchInput.val();
            if( banjiIdStartSearchValue  != 0){
                searchForm.banjiIdStart = banjiIdStartSearchValue;
            }
        }
        var banjiIdEndSearchInput = $('#banjiIdEndSearch');
        if(banjiIdEndSearchInput != null){
            var banjiIdEndSearchValue = banjiIdEndSearchInput.val();
            if( banjiIdEndSearchValue  != 0){
                searchForm.banjiIdEnd = banjiIdEndSearchValue;
            }
        }
            getDataList();
    }
    ...
    function getDataList() {
        http("yonghu/page", "GET", {
            ...
            banjiIdStart: searchForm.banjiIdStart,
            banjiIdEnd: searchForm.banjiIdEnd,
            //级联表的
