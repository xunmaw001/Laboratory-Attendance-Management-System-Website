              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">实验室名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shiyanshiName" id="shiyanshiName"  placeholder="实验室名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">实验室位置:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shiyanshiWeizhi" id="shiyanshiWeizhi"  placeholder="实验室位置"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
