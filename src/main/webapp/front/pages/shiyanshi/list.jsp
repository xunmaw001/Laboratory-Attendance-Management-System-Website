            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">实验室展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="shiyanshiName" id="shiyanshiName" placeholder="实验室名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 shiyanshiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            shiyanshiContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#shiyanshiName').val() != null && jquery('#shiyanshiName').val() != "" && jquery('#shiyanshiName').val() != "null" ) {
                param['shiyanshiName'] = jquery('#shiyanshiName').val();
            }
                            // 获取列表数据
            http.request('shiyanshi/list', 'get', param, function(res) {
