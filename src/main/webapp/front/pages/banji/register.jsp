              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">班级名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="banjiName" id="banjiName"  placeholder="班级名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">班级人数:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="banjiNumber" id="banjiNumber"  lay-verify="integer|required"   placeholder="班级人数" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
