            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">实验室预约展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yuyueName" id="yuyueName" placeholder="所上课程" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 yuyueContent 字段去除无用字符 如果字段长度大于60  就截取到60
            yuyueContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#yuyueName').val() != null && jquery('#yuyueName').val() != "" && jquery('#yuyueName').val() != "null" ) {
                param['yuyueName'] = jquery('#yuyueName').val();
            }
     
            var yuyueTypes = $("#yuyueTypes").find("option:selected").val();
            if (yuyueTypes != null && yuyueTypes != "" && yuyueTypes != "null") {
                param['yuyueTypes'] = yuyueTypes;
            }
                        // 获取列表数据
            http.request('yuyue/list', 'get', param, function(res) {
...
// 当前表的字典表
       ...
       function yuyueTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=yuyue_types", 'get', {}, function (res) {
               if(res.code == 0){
