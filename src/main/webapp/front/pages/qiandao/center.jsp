	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="qiandaoName" id="qiandaoName" lay-verify="required" placeholder="签到人" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="qiandaoTime" id="qiandaoTime"  lay-verify="required|date"   placeholder="签到时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="qiantuiTime" id="qiantuiTime"  lay-verify="required|date"   placeholder="签退时间" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`qiandao/session`, 'get', {}, function (data) {
                    // 表单赋值
