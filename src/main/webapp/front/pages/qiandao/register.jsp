              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">签到人:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="qiandaoName" id="qiandaoName"  placeholder="签到人"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">签到时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="qiandaoTime" id="qiandaoTime"  placeholder="签到时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">签退时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="qiantuiTime" id="qiantuiTime"  placeholder="签退时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
