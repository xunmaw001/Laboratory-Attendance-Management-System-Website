                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="banjiIdStart" id="banjiIdStart"  lay-skin="integer"   placeholder="所在班级开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="banjiIdend"   id="banjiIdend"    lay-skin="integer|banjiIdend"   placeholder="所在班级结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,banjiIdend: function(value, item){ //value：表单的值、item：表单的DOM对象
                    var banjiIdStart = $("#banjiIdStart").val();
                 if(banjiIdStart != null && banjiIdStart != "" && banjiIdStart != "null"){
                    var number = parseInt(value)- parseInt(banjiIdStart);
                    if(number<0){
                        return '所在班级的结束值不能小于开始值';
                    }
                 }
            }
        ...
        function pageList() {
            ...
            if (jquery('#banjiIdStart').val() != null && jquery('#banjiIdStart').val() != "" && jquery('#banjiIdStart').val() != "null" ) {
                param['banjiIdStart'] = jquery('#banjiIdStart').val();
            }
            if (jquery('#banjiIdEnd').val() != null && jquery('#banjiIdEnd').val() != "" && jquery('#banjiIdEnd').val() != "null" ) {
                param['banjiIdEnd'] = jquery('#banjiIdEnd').val();
            }
                // 获取列表数据
